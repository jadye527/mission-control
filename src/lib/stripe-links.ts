...
export interface TierPaymentLinks {
  starter: string | null
  pro: string | null
  scale: string | null
}

export function getStripePaymentLinks(): TierPaymentLinks {
  return {
...
export function getTierHref(tier: 'starter' | 'pro' | 'scale', fallback = '/signup'): string {
