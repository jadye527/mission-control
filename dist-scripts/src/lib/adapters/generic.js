...
class GenericAdapter {
    ...
    async register(agent) {
        var _a;
        event_bus_1.eventBus.broadcast('agent.created', Object.assign({ id: agent.agentId, name: agent.name, framework: agent.framework || this.framework, status: 'online' }, ((_a = agent.metadata) !== null && _a !== void 0 ? _a : {})));
    }
